...
# ============================================================================
# NOTE: POST /register, POST /login, and GET /me are defined in
# authentication.py (registered first in main.py). Duplicate endpoints
# have been removed from this file to avoid route collisions.
# ============================================================================
